...
fmt:              ## Format code using black & isort.
	$(ENV_PREFIX)isort victron_ble/
	$(ENV_PREFIX)black victron_ble/
	$(ENV_PREFIX)black tests/

.PHONY: lint
lint:             ## Run pep8, black, mypy linters.
	$(ENV_PREFIX)flake8 victron_ble/
	$(ENV_PREFIX)black --check victron_ble/
...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > victron_ble/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add victron_ble/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "victron_ble = 'victron_ble.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run victron_ble'"
